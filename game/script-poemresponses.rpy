label poemresponse_start:
    ...
    label poemresponse_start2:
        ...
        menu:
            ...
            "Sayori" if not s_readpoem and not persistent.sayori_dead:
                $ s_readpoem = True
            ...
            "Natsuki" if not n_readpoem and not persistent.natsuki_dead == 1:
                $ n_readpoem = True
                if chapter == 1 and poemsread == 0:
            ...
            "Yuri" if not y_readpoem and not y_ranaway and not persistent.yuri_dead == 1:
                $ y_readpoem = True
                if chapter == 1 and poemsread == 0:
...
label poemresponse_sayori:
    ...
    if poemwinner[0] == "sayori" and persistent.sayori_dead == 1:
        $ poemwinner[0] = "natsuki"
...
label poemresponse_natsuki:
    ...
    if poemwinner[1] == "sayori" and persistent.sayori_dead == 1:
        $ poemwinner[1] = "natsuki"
...
label poemresponse_yuri:
    ...
    if poemwinner[2] == "sayori" and persistent.sayori_dead == 1:
        $ poemwinner[2] = "natsuki"
