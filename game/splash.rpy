...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        with Dissolve(1.0)
        pause 1.0
        "This game is fan work, unaffiliated with Team Salvato."
        "Before playing, you should complete the original game, found at http://ddlc.moe."
