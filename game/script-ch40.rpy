...
label ch40_noskip:
    ...
    if persistent.current_monikatopic != 0:
        ...
        call expression "ch40_" + str(persistent.current_monikatopic)
    jump ch40_loop
    return
...
label ch40_main:
    ...
    m "About that whole thing with Yuri...and Sayori..."
    m "Well...all I had to do was talk to them."
    m "Ahaha!"
    m "I'm very persuasive."
    m "It took quite a while, but everyone has their pressure points."
    m "Everyone has their insecurities."
    m "All it took was one little push and..."
    m "I'm sorry you had to see that, though!"
    m "I was most worried about Natsuki."
    m "She had a lot of will to live."
    m "She was fighting for her life, actually."
    m "I couldn't just convince her to give up."
    m "She could've ruined everything."
    m "But then..."
    m "But then she came to you."
    m "She came crying to your door, seeking your help."
    m "And what did you tell her?"
    if persistent.natsuki_choice == 1:
        m "You told her to stand up for herself."
        m "You actually told her to defend herself against someone four times her size."
        m "I'm actually amazed she didn't just slap you."
        m "She must have been dumber than I thought."
        m "But you knew."
        m "You knew just what to say."
        m "To get her out of the picture..."
        m "So we could be together."
    else:
        m "You told her to go to an adult."
        m "That worried me even more."
        m "Almost like you were betraying me or something."
        m "But it worked out in the end, didn't it?"
        m "I should've never doubted you."
        m "I didn't realize you were so sneaky."
...
label ch40_main2:
    ...
    if not config.developer:
        $ style.say_dialogue = style.default_monika
    $ persistent.autoload = "ch40_main2"
    show mask_2
    show mask_3
    show room_mask as rm:
        size (320,180)
    ...
    m "It took a lot of effort to get here, but it was all worth it in the end."
...
label ch40_postpoem:
    $ persistent.autoload = "ch40_postpoem"
    $ m.display_args["callback"] = slow_nodismiss
    $ m.what_args["slow_abortable"] = config.developer
    $ config.skipping = False
    $ config.allow_skipping = False
    ...
    m "Let's see..."
    $ persistent.autoload = "ch40_autoload"
    jump ch40_loop
...
label ch40_endb:
    ...
    pause 15
    window auto
    "Suddenly, I gasp, catching my breath."
    "I can finally move, and think, and talk."
    "Where the hell am I?"
    mc "Hello?"
    mc "Anyone?"
    "My voice is strangely muffled."
...
label ch40_autoload:
    ...
    if persistent.monika_reload <= 4:
        call expression "ch40_reload_" + str(persistent.monika_reload)
    else:
        call ch40_reload_4
...
label ch40_13:
    ...
    m "I think I would have gone insane if you hadn't shown up."
...
label ch40_16:
    ...
    m "And drove everyone else to suicide..."
    m "Ah..."
...
label ch40_21:
    ...
    m "Even though I everyone else's files were deleted, I can still kind of feel them..."
